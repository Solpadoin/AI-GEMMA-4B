...
$existing = Get-BitsTransfer | Where-Object { $_.DisplayName -eq "Fable5 Gemma4 Q4" } | Select-Object -First 1
if ($existing) {
...
Start-BitsTransfer -Source $Source -Destination $Destination -DisplayName "Fable5 Gemma4 Q4" -Asynchronous |
